    ...
    def __call__(self, data):
        ...
        for bno in range(0, nBox):
            box = label[bno]['points']
             ...
             # add by zzm
            # polygon_shape = Polygon(np.array(box, dtype=np.float32))
...
class DetLabelEncodeMulti(object):
    def __init__(self, class_idxs = None, **kwargs):
    ...
    def __call__(self, data):
        ...
        for bno in range(0, nBox):
            ...
            txt = label[bno]['transcription']
            txt = txt.split('-')[0].split('_')[0] # add by zzm
            if txt not in self.all_class_idxs:
                txt = self.all_class_idxs[-1]
