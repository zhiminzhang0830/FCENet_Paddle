...
class ResNet_FCE(nn.Layer):
    def __init__(self, in_channels=3, layers=50, dcn_stage=[False, True, True, True], deep_stem=False, out_indices=None, **kwargs):
        super(ResNet_FCE, self).__init__()
