...
from .db_postprocess import DBPostProcess, DistillationDBPostProcess, DBPostProcessMulti, DBPostProcessMultiContours
...
def build_post_process(config, global_config=None):
    support_dict = [
        ...
        'DBPostProcessMulti', 'DBPostProcessMultiContours', 'FCEPostProcess'
    ]
